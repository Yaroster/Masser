            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td><input name="title" style="width: 100%;"
                               value="<?php if (isset($_POST['title'])) echo $_POST['title']; else echo $News->GetTitle(); ?>"/>
                    </td>
                ...
                <tr>
                    <td colspan="3"><textarea name="content" style="width: 100%;"
                                              rows="24"><?php if (isset($_POST['content'])) echo $_POST['content']; else echo $News->GetContent(); ?></textarea>
                    </td>
                </tr>
                <tr>
