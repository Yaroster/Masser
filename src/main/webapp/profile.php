        ...
        <tr>
            <td>
                <div class="profilename">
                    ...
                    if ($Target->GetBeta() == true) echo '<img class="betat" src="' . $Page->Link('includes/images/beta.png') . '"/>'; ?>
                </div>
            ...
            <td valign="top" style="padding-right: 4px;" width="60%">
                <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="profilel1">
                        ...
                        <td align="right"><?php if ($Target->GetPlaytion() == $Page->GetFunctions()->GetConstants()->GetEmptyDate()) {
                                echo $Page->GetLanguage()->GetText('pages.profile.firsttable.never');
                            } else {
                                echo utf8_encode(strftime("%A %d %B, %H:%M", strtotime($Page->GetPlayer()->GetCountry()->DecaleDate($Target->GetPlaytion()))));
                            } ?></td>
                    </tr>
                </table>
                <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="profilel1">
                        ...
                        <td align="right"><?php $Page->GetFunctions()->Load('language');
                            $Language = new Language($Page, $Target->GetLanguage(), false);
                            echo $Language->GetFull(); ?></td>
                    </tr>
                    <tr class="profilel2">
                        <td><?php echo $Page->GetLanguage()->GetText('pages.profile.secondtable.whitelist'); ?></td>
                        <td align="right"><?php if ($Target->GetWhite()) {
                                echo $Page->GetLanguage()->GetText('pages.profile.represent.status.yes');
                            } else {
                                echo $Page->GetLanguage()->GetText('pages.profile.represent.status.no');
                            } ?></td>
                ...
                <form method="post" action="">
                    <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
                        ...
                        <tr class="profilel1">
                            ...
                            <td align="right"><select name="misible">
                                    <option value="1"<?php if ($Target->GetMisible()) {
                                        echo ' selected';
                                    } ?>><?php echo ucfirst($Page->GetLanguage()->GetText('pages.profile.represent.status.yes')); ?></option>
                                    <option value="0"<?php if (!$Target->GetMisible()) {
                                        echo ' selected';
                                    } ?>><?php echo ucfirst($Page->GetLanguage()->GetText('pages.profile.represent.status.no')); ?></option>
                                </select></td>
                        </tr>
                        <tr class="profilel2">
                            <td valign="top"
                                width="50%"><?php echo $Page->GetLanguage()->GetText('pages.profile.fifthtable.cpass'); ?></td>
                            <td align="right"><input name="old"
                                                     maxlength="<?php echo $Page->GetFunctions()->GetConstants()->GetMaxPasswordSize(); ?>"
                                                     type="password"
                                                     placeholder="<?php echo $Page->GetLanguage()->GetText('pages.profile.fifthtable.cpass.old'); ?>"/><input
                                        name="new"
                                        maxlength="<?php echo $Page->GetFunctions()->GetConstants()->GetMaxPasswordSize(); ?>"
                                        type="password"
                                        placeholder="<?php echo $Page->GetLanguage()->GetText('pages.profile.fifthtable.cpass.new'); ?>"/><input
                                        name="renew"
                                        maxlength="<?php echo $Page->GetFunctions()->GetConstants()->GetMaxPasswordSize(); ?>"
                                        type="password"
                                        placeholder="<?php echo $Page->GetLanguage()->GetText('pages.profile.fifthtable.cpass.renew'); ?>"/>
                            </td>
                        </tr>
                        <tr class="profilel1">
                        ...
                        <tr class="profilel1">
                            <td colspan="2" align="center" width="50%"><input type="submit"
                                                                              value="<?php echo $Page->GetLanguage()->GetText('pages.profile.fifthtable.submit'); ?>"/>
                            </td>
                        </tr>
                    </table>
                </form>
            ...
            <td valign="top" style="padding-left: 4px;" width="50%">
                <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="profilel1">
                        ...
                        <td align="right"><?php $Times = $Page->GetFunctions()->SecondsFormat($Target->GetPlaymin());
                            echo $Times['h'] . $Page->GetLanguage()->GetText('pages.profile.thirdtable.hours') . ' ' . $Times['m'] . $Page->GetLanguage()->GetText('pages.profile.thirdtable.minutes') . ' ' . $Times['s'] . $Page->GetLanguage()->GetText('pages.profile.thirdtable.seconds'); ?></td>
                    </tr>
                    <tr class="profilel2">
                ...
                <table style="width: 100%; margin-bottom: 0;" class="profiletop" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="profilel1">
                        ...
                        <td align="right"
                            valign="top"><?php echo '<a href="mailto:' . $Target->GetMail() . '">' . $Target->GetMail() . '</a>'; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
                    ...
                    <tr class="profilel1">
                        ...
                        <td align="right"><?php if ($Target->GetPlaytion() == $Page->GetFunctions()->GetConstants()->GetEmptyDate()) {
                                ...
                                echo utf8_encode(strftime("%A %d %B, %H:%M", strtotime($Page->DecaleDate($Target->GetPlaytion()))));
                            } ?></td>
                    </tr>
                </table>
                <table style="width: 100%;" class="profiletop" cellpadding="2" cellspacing="0">
