            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td><input name="title" style="width: 100%;"
                               value="<?php if (isset($_POST['title'])) echo $_POST['title']; ?>"/></td>
                ...
                <tr>
                    <td colspan="3"><textarea name="content" style="width: 100%;"
                                              rows="24"><?php if (isset($_POST['content'])) echo $_POST['content']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="center">
                        <input type="submit"
                               value="<?php echo $Page->GetLanguage()->GetText('pages.administration.table.submit'); ?>"/>
                    </td>
                </tr>
            </table>
        </form>
