...
class Page
{
    ...
    public function Head($Title = '', $Load = false)
    {
        ...
        <div id="toptop">
            <table>
                <tr align="left">
                    <td><?php echo ucfirst(utf8_encode(strftime("%A %d %B, %H:%M", strtotime($this->DecaleDate())))); ?></td>
                    <td align="right">
                        <?php
        ...
        <div id="head">
            ...
            <div id="turkraft">
                ...
                <span id="address"
                      class="<?php if ($this->Functions->GetConstants()->GetVariables()->Get('online') == 1) {
                          echo 'online';
                      } else {
                          echo 'offline';
                      } ?>"><?php echo $this->Language->GetText('head.beta'); ?></span>
        ...
        <td id="rpanel" valign="top">
            <div class="part">
                ...
                <div class="shows">
                    ...
                    <div class="subpart">
									<span class="subtitle<?php if ($this->Functions->IsTSOnline()) {
                                        echo ' online';
                                    } else {
                                        echo ' offline';
                                    } ?>">
