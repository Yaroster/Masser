        ...
        <form method="post" action="">
            <table>
                <tr>
                    ...
                    <td align="right">
                        <input name="name"
                               maxlength="<?php echo $Page->GetFunctions()->GetConstants()->GetMaxNameSize(); ?>"
                               value="<?php if (isset($_POST['name'])) echo $_POST['name']; ?>" style="width: 100%;"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td align="right">
                        <input name="mail"
                               maxlength="<?php echo $Page->GetFunctions()->GetConstants()->GetMaxMailSize(); ?>"
                               value="<?php if (isset($_POST['mail'])) echo $_POST['mail']; ?>" style="width: 100%;"/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <input type="submit"
                               value="<?php echo $Page->GetLanguage()->GetText('pages.register.submit'); ?>"/>
                    </td>
                </tr>
            </table>
        </form>
