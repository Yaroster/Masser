...
//        }
    ...
    public void onHangingBreakByEntity(HangingBreakByEntityEvent event) {
        ...
        Gamer gamer = this.main.getGamer(event.getRemover().getName(), true);
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.PHYSICAL && event.getClickedBlock() != null && (event.getClickedBlock().getType() == Material.FARMLAND || event.getClickedBlock().getType() == Material.OAK_PRESSURE_PLATE || event.getClickedBlock().getType() == Material.STONE_PRESSURE_PLATE)) {
    ...
    private boolean canBeInteracted(Material material) {
        return material == Material.CHEST || material == Material.CRAFTING_TABLE || material == Material.FURNACE || material == Material.OAK_DOOR || material == Material.RED_BED || material == Material.OAK_BOAT || material == Material.STONE_BUTTON || material == Material.OAK_BUTTON || material == Material.LEVER || material == Material.ENCHANTING_TABLE || material == Material.JUKEBOX || material == Material.END_PORTAL_FRAME || material == Material.MINECART || material == Material.OAK_SAPLING || material == Material.OAK_TRAPDOOR || material == Material.CAULDRON || material == Material.BREWING_STAND || material == Material.FLOWER_POT || material == Material.OAK_FENCE_GATE || material == Material.ENDER_CHEST || material == Material.BEACON || material == Material.ANVIL || material == Material.REPEATER || material == Material.NOTE_BLOCK || material == Material.TNT || material == Material.CAKE || material == Material.DISPENSER;
    }
    ...
    public void onPotionSplash(PotionSplashEvent event) {
        ...
        if (!event.isCancelled()) {
            ...
            for (int i = 0; i < affectedEntities.length; i++) {
                ...
                Gamer target = this.main.getGamer(affectedEntities[i].getName(), true);
    ...
    public void onEntityDamageEntity(EntityDamageByEntityEvent event) {
        if (event.getDamager().getType() != EntityType.PLAYER) //si l'attaqueur n'est pas un joueur
        {
            ...
            Gamer target = this.main.getGamer(event.getEntity().getName(), true); //receveur
            ...
            if (damager.getType() == EntityType.PLAYER) {
                Gamer realDamager = this.main.getGamer(damager.getName(), true);
        ...
        Gamer attacker = this.main.getGamer(event.getDamager().getName(), true); //attaqueur
    ...
    public void onDeath(PlayerDeathEvent event) {
        Gamer killedGamer = this.main.getGamer(event.getEntity().getName(), true);
            ...
            if (damageEvent instanceof EntityDamageByEntityEvent) {
                ...
                if (!(entityDamageEvent.getDamager() instanceof Projectile)) {
                    ...
                    for (int i = 0; i < languages.length; i++) {
                        this.main.broadcastSameLanguage(languages[i].id, this.main.getText(languages[i].id, "death.mob.kills", this.main.colors.diverse, killedGamer.getNameColor(), this.main.getText(languages[i].id, "mobs." + entityDamageEvent.getDamager().getType().toString().toLowerCase(), this.main.colors.diverse)));
                    }
                } else {
                    ...
                    if (shooter instanceof Entity) {
                        ...
                        for (int i = 0; i < languages.length; i++) {
                            ...
                            this.main.broadcastSameLanguage(languages[i].id, this.main.getText(languages[i].id, "death.mob.kills", this.main.colors.diverse, killedGamer.getNameColor(), this.main.getText(languages[i].id, "mobs." + entityTypeString, this.main.colors.diverse)));
                        }
                    } else {
                    }
                }
        ...
        if (killer.getType() == EntityType.PLAYER) {
            Gamer killerGamer = this.main.getGamer(killer.getName(), true);
    ...
    public void onEntityDeath(EntityDeathEvent event) {
        ...
        Gamer killer = this.main.getGamer(event.getEntity().getKiller().getName(), true);
    ...
    public void onCommandPreprocess(PlayerCommandPreprocessEvent event) {
        ...
        String head = message.substring(1);
    ...
    public commandState onCommand(Gamer gamer, String label, String[] args) {
        ...
        if (label.equalsIgnoreCase("invisibleversion")) {
            gamer.sendMessage("command.version", this.main.colors.diverse, Masser.VERSION);
        ...
        if (label.equalsIgnoreCase("l")) {
            ...
            this.main.broadcastSameLanguage(gamer.information.language, Manipulation.chatFormat(this.main.colors.language, gamer.getNameTag(), Manipulation.charsFromArraySeparator(args, " "), false));
        ...
        if (label.equalsIgnoreCase("setspawn")) //definir le point de spawn des joueurs
        {
            ...
            gamer.sendMessage("command.setspawn.changed", this.main.colors.diverse, Integer.toString(this.main.configuration.spawnPoint.getBlockX()), Integer.toString(this.main.configuration.spawnPoint.getBlockY()), Integer.toString(this.main.configuration.spawnPoint.getBlockZ()));
        ...
        if (label.equalsIgnoreCase("appear")) //faire apparaitre une entite
        {
            ...
            Location spawnLocation = new Location(gamer.stockedLeftClickLocation.getWorld(), gamer.stockedLeftClickLocation.getBlockX(), gamer.stockedLeftClickLocation.getY() + 1, gamer.stockedLeftClickLocation.getZ());

            for (int i = 0; i < amount; i++) {
                gamer.stockedLeftClickLocation.getWorld().spawnEntity(spawnLocation, entity);
            }

            gamer.sendMessage("command.appear.ok", this.main.colors.diverse, Integer.toString(amount), this.main.getText(gamer.information.language, "mobs." + entity.toString().toLowerCase()));
        ...
        if (label.equalsIgnoreCase("top")) {
            ...
            gamer.sendMessage("command.top.ok", this.main.colors.diverse, Integer.toString(gamer.source.getLocation().getBlockX()), Integer.toString(gamer.source.getLocation().getBlockY()), Integer.toString(gamer.source.getLocation().getBlockZ()));
        ...
        if (label.equalsIgnoreCase("bed")) {
            ...
            gamer.sendMessage("command.bed.ok", this.main.colors.diverse, Integer.toString(gamer.source.getLocation().getBlockX()), Integer.toString(gamer.source.getLocation().getBlockY()), Integer.toString(gamer.source.getLocation().getBlockZ()));
        ...
        if (label.equalsIgnoreCase("location")) {
            ...
            if (args[0].equalsIgnoreCase(gamer.information.name)) {
                gamer.sendMessage("command.location.yourposition", this.main.colors.diverse, Integer.toString(gamer.source.getLocation().getBlockX()), Integer.toString(gamer.source.getLocation().getBlockY()), Integer.toString(gamer.source.getLocation().getBlockZ()));
            ...
            gamer.sendMessage("command.location.hisposition", this.main.colors.diverse, locatedGamer.getNameColor(), Integer.toString(locatedGamer.source.getLocation().getBlockX()), Integer.toString(locatedGamer.source.getLocation().getBlockY()), Integer.toString(locatedGamer.source.getLocation().getBlockZ()));
        ...
        if (label.equalsIgnoreCase("sethealth")) {
            ...
            switch (resultCommand.result) {
                case Ok:
                    ...
                    targetGamer.sendMessage("command.sethealth.you", this.main.colors.diverse, Integer.toString(resultCommand.value));
                    gamer.sendMessage("command.sethealth.him", this.main.colors.diverse, targetGamer.getNameColor(), Integer.toString(resultCommand.value));
                    return commandState.Accepted;
        ...
        if (label.equalsIgnoreCase("setfood")) {
            ...
            switch (resultCommand.result) {
                case Ok:
                    ...
                    targetGamer.sendMessage("command.setfood.you", this.main.colors.diverse, Integer.toString(resultCommand.value));
                    gamer.sendMessage("command.setfood.him", this.main.colors.diverse, targetGamer.getNameColor(), Integer.toString(resultCommand.value));
                    return commandState.Accepted;
        ...
        if (label.equalsIgnoreCase("setlevel")) {
            ...
            switch (resultCommand.result) {
                case Ok:
                    ...
                    targetGamer.sendMessage("command.setlevel.you", this.main.colors.diverse, Integer.toString(resultCommand.value));
                    gamer.sendMessage("command.setlevel.him", this.main.colors.diverse, targetGamer.getNameColor(), Integer.toString(resultCommand.value));
                    return commandState.Accepted;
        ...
        if (label.equalsIgnoreCase("givexp")) {
            ...
            switch (resultCommand.result) {
                case Ok:
                    ...
                    targetGamer.sendMessage("command.givexp.you", this.main.colors.diverse, Integer.toString(resultCommand.value));
                    gamer.sendMessage("command.givexp.him", this.main.colors.diverse, targetGamer.getNameColor(), Integer.toString(resultCommand.value));
                    return commandState.Accepted;
        ...
        if (label.equalsIgnoreCase("back")) {
            ...
            if (args.length == 0) {
                ...
                gamer.sendMessage("command.back.ok", this.main.colors.diverse, Integer.toString(gamer.deathLocation.getBlockX()), Integer.toString(gamer.deathLocation.getBlockY()), Integer.toString(gamer.deathLocation.getBlockZ()));
            ...
            if (args.length == 1) {
                ...
                toBack.sendMessage("command.back.ok", this.main.colors.diverse, Integer.toString(toBack.deathLocation.getBlockX()), Integer.toString(toBack.deathLocation.getBlockY()), Integer.toString(toBack.deathLocation.getBlockZ()));
        ...
        if (label.equalsIgnoreCase("plot")) {
            ...
            if (args.length == 0) {
                ...
                if (getter.pricable.isToSell()) {
                    if (!getter.owner.hasOwner()) {
                        gamer.sendMessage("command.terrain.info.tosell.noowner", this.main.colors.territory, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ), Integer.toString(getter.pricable.price));

                        return commandState.Accepted;
                    }

                    if (getter.owner.isOwner(gamer)) {
                        gamer.sendMessage("command.terrain.info.tosell.you", this.main.colors.territory, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ), Integer.toString(getter.pricable.price));

                        return commandState.Accepted;
                    }

                    gamer.sendMessage("command.terrain.info.tosell.him", this.main.colors.territory, getter.owner.owner, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ), Integer.toString(getter.pricable.price));

                    return commandState.Accepted;
                }

                if (!getter.owner.hasOwner()) {
                    gamer.sendMessage("command.terrain.info.notsell.noowner", this.main.colors.territory, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ));

                    return commandState.Accepted;
                }

                if (getter.owner.isOwner(gamer)) {
                    gamer.sendMessage("command.terrain.info.notsell.you", this.main.colors.territory, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ));

                    return commandState.Accepted;
                }

                gamer.sendMessage("command.terrain.info.notsell.him", this.main.colors.territory, getter.owner.owner, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ));
            ...
            if (args.length == 1 && !args[0].equalsIgnoreCase("create")) //on ne traite pas le arg "create" ici
            {
                if (args[0].equalsIgnoreCase("price")) {
                    ...
                    gamer.sendMessage("command.plot.price", this.main.colors.territory, Integer.toString(terrainPrice.getEstimatedPrice()), Integer.toString(terrainPrice.plot.sizeX), Integer.toString(terrainPrice.plot.sizeZ));
                ...
                if (args[0].equalsIgnoreCase("buy")) {
                    ...
                    if (getter.owner.hasOwner()) {
                        ...
                        if (ownerGamer != null) {
                            ownerGamer.sendMessage("command.terrain.selled", this.main.colors.territory, gamer.getNameColor(), Integer.toString(getter.pricable.price));
            ...
            if (args.length >= 1) {
                ...
                if (args[0].equalsIgnoreCase("create")) {
                    ...
                    if ((addPlot.sizeX < this.main.configuration.minimumLengthTerrain || addPlot.sizeZ < this.main.configuration.minimumLengthTerrain) && !gamer.grad.canGodTerritories) {
                        gamer.sendMessage("command.terrain.create.toosmall", this.main.colors.territory, Integer.toString(this.main.configuration.minimumLengthTerrain));

                        return commandState.Accepted;
                    }

                    if ((addPlot.sizeX > this.main.configuration.maximumLengthTerrain || addPlot.sizeZ > this.main.configuration.maximumLengthTerrain) && !gamer.grad.canGodTerritories) {
                        gamer.sendMessage("command.terrain.create.toobig", this.main.colors.territory, Integer.toString(this.main.configuration.maximumLengthTerrain));
                    ...
                    if (gamer.information.money < estimatedPrice) {
                        gamer.sendMessage("command.terrain.create.nomoney", this.main.colors.territory, Integer.toString(estimatedPrice));
                    ...
                    gamer.sendMessage("command.terrain.create.ok", this.main.colors.territory, Integer.toString(addPlot.sizeX), Integer.toString(addPlot.sizeZ), Integer.toString(estimatedPrice));
        ...
        if (label.equalsIgnoreCase("unbreak")) {
            ...
            if (args.length == 0) {
                ...
                gamer.sendMessage("command.unbreak.info", this.main.colors.territory, getter.creator.owner, Integer.toString(getter.plot.sizeX), Integer.toString(getter.plot.sizeZ));
        ...
        if (label.equalsIgnoreCase("g")) {
            ...
            this.main.getGroup(gamer.groupid).broadcast(Manipulation.chatFormat(this.main.colors.group, gamer.getNameTag(), Manipulation.charsFromArraySeparator(args, " "), false));
        ...
        if (label.equalsIgnoreCase("group")) {
            ...
            if (args.length == 0) {
                ...
                gamer.sendMessage("command.group.list", this.main.colors.group, this.main.getGroup(gamer.groupid).getList(), ChatColor.GREEN.toString());
            ...
            if (args.length == 2) {
                if (args[0].equalsIgnoreCase("eject")) {
                    ...
                    gamer.sendMessage("command.group.eject.ok", this.main.colors.group, toEjectGamer.getNameColor(), ChatColor.GREEN.toString());

                    for (int i = 0; i < gamer.getGroup().members.size(); i++) {
                        gamer.getGroup().members.get(i).sendMessage("command.group.eject.ok", this.main.colors.group, toEjectGamer.getNameColor(), ChatColor.GREEN.toString());
                    }
                ...
                if (args[0].equalsIgnoreCase("invite")) {
                    ...
                    if (inviteGamer.inGroup()) {
                        gamer.sendMessage("command.group.invite.already", this.main.colors.group, inviteGamer.getNameColor(), ChatColor.GREEN.toString());
                    ...
                    inviteGamer.sendMessage("command.invite.message", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());

                    gamer.sendMessage("command.group.invite.sent", this.main.colors.group, inviteGamer.getNameColor(), ChatColor.GREEN.toString());
            ...
            if (args.length == 1) {
                if (args[0].equalsIgnoreCase("refuse")) {
                    ...
                    gamer.sendMessage("command.group.refuse.ok", this.main.colors.group, joinGroup.host.getNameColor(), ChatColor.GREEN.toString());

                    joinGroup.host.sendMessage("command.group.refuse.herefused", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());
                ...
                if (args[0].equalsIgnoreCase("accept")) {
                    ...
                    joinGroup.host.sendMessage("command.group.accept.ok", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());

                    for (int i = 0; i < this.main.getGroup(gamer.groupid).members.size(); i++) {
                        this.main.getGroup(gamer.groupid).members.get(i).sendMessage("command.group.accept.ok", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());
                    }
        ...
        if (label.equalsIgnoreCase("shop")) //on utilise AIR au lieu de ITEM_FRAME comme ce n'est pas un block de stocker de le location
        {
            if (args.length == 0) //information sur le magasin
            {
                ...
                if (gamer.stockedLeftClickLocation.getBlock().getType() != Material.OAK_SIGN && gamer.stockedLeftClickLocation.getBlock().getType() != Material.OAK_WALL_SIGN && gamer.stockedLeftClickLocation.getBlock().getType() != Material.AIR) {
                ...
                gamer.sendMessage("command.shop.info", this.main.colors.shop, this.main.getMaterialName(gamer.information.language, shop.get().getType()), Integer.toString(shop.pricable.price), Integer.toString(shop.quantity));
            ...
            if (args.length == 2 && !args[1].equalsIgnoreCase("not")) {
                if (args[0].equalsIgnoreCase("set")) {
                    ...
                    if (gamer.stockedLeftClickLocation.getBlock().getType() != Material.OAK_SIGN && gamer.stockedLeftClickLocation.getBlock().getType() != Material.OAK_WALL_SIGN) {
                    ...
                    gamer.sendMessage("command.shop.priceupdated", this.main.colors.shop, Integer.toString(price));
        ...
        if (label.equalsIgnoreCase("tc")) {
            ...
            gamer.sendMessage("command.clan.tp.ok", this.main.colors.clan, Integer.toString(clan.spawn.getBlockX()), Integer.toString(clan.spawn.getBlockY()), Integer.toString(clan.spawn.getBlockZ()));
        ...
        if (label.equalsIgnoreCase("clan")) {
            ...
            if (args.length >= 1 && args[0].equalsIgnoreCase("create")) {
                ...
                if (addPlot.sizeX < this.main.configuration.minimumLengthClan || addPlot.sizeZ < this.main.configuration.minimumLengthClan) {
                    gamer.sendMessage("command.clan.create.toosmall", this.main.colors.clan, Integer.toString(this.main.configuration.minimumLengthClan));
                ...
                if (gamer.information.money < price) {
                    gamer.sendMessage("command.clan.create.nomoney", this.main.colors.clan, Integer.toString(price));
            ...
            if (clan == null) {
                if (args.length == 1) {
                    if (args[0].equalsIgnoreCase("price")) {
                        ...
                        gamer.sendMessage("command.clan.price", this.main.colors.clan, Integer.toString(clanPrice.getEstimatedPrice()), Integer.toString(clanPrice.plot.sizeX), Integer.toString(clanPrice.plot.sizeZ));
            ...
            if (args.length == 0) {
                gamer.sendMessage("command.clan.list", this.main.colors.clan, clan.getList());
            ...
            if (args.length >= 2 && !args[0].equalsIgnoreCase("give") && !args[0].equalsIgnoreCase("rank")) {
                if (args[0].equalsIgnoreCase("offer")) {
                    ...
                    if (gamer.information.money < money) {
                        gamer.sendMessage("command.clan.offer.notenough", this.main.colors.clan, Integer.toString(money));
        ...
        if (label.equalsIgnoreCase("lag")) {
            ...
            gamer.sendMessage("command.lag.ok", this.main.colors.diverse, Long.toString(freeMemory / 1024), Long.toString(allocatedMemory / 1024 / 1024), Long.toString(maxMemory / 1024), Long.toString((freeMemory + (maxMemory - allocatedMemory)) / 1024), Integer.toString(this.main.getServer().getWorld("world").getEntities().size()));
        ...
        if (label.equalsIgnoreCase("distance")) {
            ...
            gamer.sendMessage("command.distance.ok", this.main.colors.diverse, locatedGamer.getNameColor(), Integer.toString((int) locatedGamer.source.getLocation().distance(gamer.source.getLocation())));
        ...
        if (label.equalsIgnoreCase("jail")) {
            ...
            if (!gamer.is(jailed)) {
                gamer.sendMessage("command.jail.ok", this.main.colors.prison, jailed.getNameColor(), this.main.getText(gamer.information.language, this.main.colors.prison, prison.getAbbreviation()), Integer.toString(blocks));
            }

            this.main.broadcastAdminChat(ChatColor.RED + "-> " + gamer.getNameColorPersonnalized(ChatColor.RED) + " jails " + jailed.getNameColorPersonnalized(ChatColor.RED) + " in " + args[2] + " with " + blocks + " ores.");
        ...
        if (label.equalsIgnoreCase("unjail")) {
            ...
            if (!gamer.is(jailed)) {
                gamer.sendMessage("command.unjail.ok", this.main.colors.prison, jailed.getNameColor(), this.main.getText(gamer.information.language, jailed.getPrison().getAbbreviation()));
            }
    ...
    private void simulateGroupExit(Gamer gamer) {
        if (this.main.getGroup(gamer.groupid).isHost(gamer)) {
            ...
            if (newHostGamer == null) {
                ...
                newHostGamer.sendMessage("command.group.youarenewhost", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());

                for (int i = 0; i < newHostGamer.getGroup().members.size(); i++) {
                    newHostGamer.getGroup().members.get(i).sendMessage("command.group.newhost", this.main.colors.group, gamer.getNameColor(), newHostGamer.getNameColor(), ChatColor.GREEN.toString());
                }
            }
        ...
        this.main.getGroup(hisGroupId).getHost().sendMessage("command.group.hasquit", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());

        for (int i = 0; i < this.main.getGroup(hisGroupId).members.size(); i++) {
            this.main.getGroup(hisGroupId).members.get(i).sendMessage("command.group.hasquit", this.main.colors.group, gamer.getNameColor(), ChatColor.GREEN.toString());
        }
    ...
    public enum commandState {
        Accepted, Error, NoRights, Incorrect
    }
}