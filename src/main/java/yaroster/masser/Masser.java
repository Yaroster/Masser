...
public class Masser extends JavaPlugin {
    ...
    public HashMap<String, String> setConfigValues() {

        configValues.put("acceptConnections", "true");
        configValues.put("maximumBuyMoney", "1000");
        configValues.put("maximumKillMoney", "500");
        configValues.put("maximumPlayers", "100");
        configValues.put("spawnPoint", "world,0,64,0");
        configValues.put("whiteList", "false");
        configValues.put("defaultLanguage", "1");
        configValues.put("killMoneyPourcentage", "10");
        configValues.put("killPourcentageRandom", "5");
        configValues.put("rimeInterval", "2400,4800");
        configValues.put("protectedSpawnTime", "30");
        configValues.put("minimumLengthTerrain", "10");
        configValues.put("mobKillEachOther", "false");
        configValues.put("maximumGroupGamer", "10");
        configValues.put("restartTime", "7200");
        configValues.put("stopTime", "300");
        configValues.put("saveInterval", "600");
        configValues.put("whitelistMax", "100");
        configValues.put("maximumLengthTerrain", "50");
        configValues.put("clanCollision", "5");
        configValues.put("minimumLengthClan", "15");
        configValues.put("alertRestClan", "10");
        configValues.put("clanMinimumInteract", "3");
        configValues.put("maximumClanMembers", "30");
        configValues.put("checkSession", "true");
        configValues.put("fightMinimumReco", "60"); // en secondes
        configValues.put("fightInterval", "300"); // en secondes
        configValues.put("restart", "true");
//		configValues.put("dbUrl", "jdbc:mysql://adresseServeur:port/baseDeDonnees");
//		configValues.put("dbUser", "utilisateur");
//		configValues.put("dbPassword", "motDePasse");
        configValues.put("rimeInterval1", "2400");
        configValues.put("rimeInterval2", "4800");
    ...
    public void onEnable() {
        ...
        try {
            configuration = new Configuration(setConfigValues());
...
//                this.database.updateTeleporter(this.teleporters.get(i));
    ...
    public String getText(int language, ChatColor color, String abbreviation) {
        return this.getText(language, abbreviation, color);
    }
    ...
    public void broadcastRimeText(int selected) {
        for (Map.Entry<String, Gamer> entry : this.gamers.entrySet()) {
            entry.getValue().source.sendMessage(ChatColor.RED + this.getRime(entry.getValue().information.language, selected));
        }

        this.networker.send(ChatColor.RED + this.getRime(this.configuration.defaultLanguage, selected));
    }
    ...
    private void checkTimes() {
        ...
        long l = this.getServer().getWorlds().get(0).getTime();
