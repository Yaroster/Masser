...
//	private MySQL connection;
    ...
    public Database(Masser main) {
        ...
        this.main.constants.get("mysql.login");
        this.main.constants.get("mysql.password");
    }
...
//        try {
//            while (queryResult.next()) {
//                terrains.add(new Terrain(queryResult.getInt("id"), new Ownable(queryResult.getString("owner")), Manipulation.plotFromString(this.main, queryResult.getString("location")), new Whitisble(Manipulation.stringArrayFromSplit(queryResult.getString("whitelist"), Manipulation.separator)), new Pricable(queryResult.getInt("price")), queryResult.getBoolean("breakable")));
//            }
//        } catch (SQLException ex) {
//            this.main.log.error(ex);
//
...
//        try {
//            while (queryResult.next()) {
//                indestructibles.add(new Indestructible(queryResult.getInt("id"), new Ownable(queryResult.getString("creator")), Manipulation.plotFromString(this.main, queryResult.getString("location"))));
//            }
//        } catch (SQLException ex) {
//            this.main.log.error(ex);
//
...
//        this.connection.ExecuteInsert("INSERT INTO blocks(creator, location) VALUES('" + indestructible.creator.owner + "', '" + Manipulation.plotLocationToString(indestructible.plot) + "')");
//
...
//        this.connection.ExecuteInsert("INSERT INTO territories(owner, location, breakable, whitelist, price) VALUES('" + terrain.owner.owner + "', '" + Manipulation.plotLocationToString(terrain.plot) + "', " + (terrain.breakable ? 1 : 0) + ", '" + Manipulation.charsFromArraySeparator(terrain.whitisble.whiteGamers.toArray(new String[0]), Manipulation.separator) + "', " + terrain.pricable.price + ")");
//
//        terrain.id = this.connection.GetLastId("territories");
//    }
//
//    public void updateTerrain(Terrain terrain) {
//        this.connection.ExecuteUpdate("UPDATE territories SET owner = '" + terrain.owner.owner + "', location = '" + Manipulation.plotLocationToString(terrain.plot) + "' " + ", whitelist = '" + Manipulation.charsFromArraySeparator(terrain.whitisble.whiteGamers.toArray(new String[0]), Manipulation.separator) + "', " + "price = " + terrain.pricable.price + ", breakable = " + (terrain.breakable ? 1 : 0) + " WHERE id = " + terrain.id);
//    }
//
...
//        try {
//            while (queryResult.next()) {
//                clans.put(queryResult.getInt("virtual"), new Clan(queryResult.getInt("virtual"), queryResult.getString("name"), Manipulation.plotFromString(this.main, queryResult.getString("location")), queryResult.getInt("score"), queryResult.getInt("chief"), queryResult.getInt("money"), queryResult.getInt("taken"), Manipulation.getLocationWorld(queryResult.getString("spawn"), true), queryResult.getInt("total")));
//            }
//        } catch (SQLException ex) {
//            this.main.log.error(ex);
//
...
//        this.connection.ExecuteInsert("INSERT INTO clans(virtual, name, location, score, chief, money, taken, spawn, total) VALUES(" + +clan.virtual + ", '" + clan.name + "', '" + Manipulation.plotLocationToString(clan.plot) + "', " + clan.score + ", " + clan.chiefId + ", " + clan.money + ", " + clan.taken + ", '" + Manipulation.getLocationWorld(clan.spawn, true) + "', " + clan.countMembers + ")");
//    }
//
//    public void updateClan(Clan clan) {
//        this.connection.ExecuteUpdate("UPDATE clans SET money = " + clan.money + ", score = " + clan.score + ", taken = " + clan.taken + ", " + "total = " + clan.countMembers + ", spawn = '" + Manipulation.getLocationWorld(clan.spawn, true) + "' WHERE virtual = " + clan.virtual);
//    }
//
...
//
//                shops.put(location, new Shop(queryResult.getInt("id"), new Ownable(queryResult.getString("owner")), new Pricable(queryResult.getInt("price")), queryResult.getBoolean("diminuates"), Material.getMaterial(String.valueOf(queryResult.getInt("material"))), queryResult.getInt("quantity"), location, queryResult.getInt("sells"), queryResult.getShort("data")));
//            }
//        } catch (SQLException ex) {
//            this.main.log.error(ex);
//
...
//        this.connection.ExecuteInsert("INSERT INTO shops(owner, price, material, position, quantity, diminuates, sells, data) VALUES('" + shop.ownable.owner + "', " + shop.pricable.price + ", '" + shop.material.name() + "', '" + Manipulation.getLocationWorld(shop.position) + "', " + shop.quantity + ", " + (shop.diminuates ? 1 : 0) + ", " + shop.sells + ", " + shop.data + ")");
//
...
//        this.connection.ExecuteUpdate("UPDATE shops SET price = " + shop.pricable.price + ", material = " + shop.material.name() + ", quantity = " + shop.quantity + ", sells = " + shop.sells + ", data = " + shop.data + " WHERE id = " + shop.id);
//    }
//
...
//        try {
//            while (queryResult.next()) {
//                teleporters.add(new Teleporter(queryResult.getInt("id"), queryResult.getString("name"), Manipulation.getLocationWorld(queryResult.getString("initial")), Manipulation.getLocationWorld(queryResult.getString("destination"), true)));
//            }
//        } catch (SQLException ex) {
//            this.main.log.error(ex);
//
...
//        this.connection.ExecuteInsert("INSERT INTO teleporter(initial, destination, name) VALUES('" + Manipulation.getLocationWorld(teleporter.initial) + "', '" + Manipulation.getLocationWorld(teleporter.destination) + "', '" + teleporter.name + "')");
//
//        teleporter.id = this.connection.GetLastId("teleporter");
//    }

//    public void updateTeleporter(Teleporter teleporter) {
//        this.connection.ExecuteUpdate("UPDATE teleporter SET name = '" + teleporter.name + "', initial = '" + Manipulation.getLocationWorld(teleporter.initial) + "', " + "destination = '" + Manipulation.getLocationWorld(teleporter.destination) + "'" + "' WHERE id = " + teleporter.id);
//    }
...
//        ResultSet queryResult = this.connection.ExecuteSelect("SELECT * FROM prisons");
        ...
        try {
//            while (queryResult.next()) {
//                prisons.add(new Prison(this.main, queryResult.getInt("id"), queryResult.getString("variable"), Manipulation.plotFromString(this.main, queryResult.getString("location")), Manipulation.getLocationWorld(queryResult.getString("spawn")), Manipulation.getLocationWorld(queryResult.getString("quit")), queryResult.getInt("counter")));
//            }
        } catch (Exception ex) {
            this.main.log.error(ex);
...
//        this.connection.ExecuteInsert("INSERT INTO prisons(spawn, quit, variable, counter, location) VALUES(" + "'" + Manipulation.getLocationWorld(prison.spawn) + "', " + "'" + Manipulation.getLocationWorld(prison.exit) + "', " + "'" + prison.variable + "'" + ", " + prison.counter + ", " + "'" + Manipulation.plotLocationToString(prison.plot) + "'" + ")");
//
//        prison.id = this.connection.GetLastId("prisons");
    }

    public void updatePrison(Prison prison) {
//        this.connection.ExecuteUpdate("UPDATE prisons SET " + "counter = " + prison.counter + ", spawn = '" + Manipulation.getLocationWorld(prison.spawn) + "', " + "quit = '" + Manipulation.getLocationWorld(prison.exit) + "'" + " WHERE id = " + prison.id);
    }
...
//
//                prisches.put(location, new Prische(queryResult.getInt("id"), this.main.getPrison(queryResult.getInt("prison")), location, Manipulation.getDinger(queryResult.getString("timing"), true)));
//            }
        } catch (Exception ex) {
            this.main.log.error(ex);
...
//        this.connection.ExecuteInsert("INSERT INTO prisches(prison, location, timing) VALUES(" + prische.prison.id + ", " + "'" + Manipulation.getLocationWorld(prische.location) + "', " + "'" + Manipulation.getDinger(prische.interval) + "'" + ")");
//
...
//                Location location = Manipulation.getLocationWorld(queryResult.getString("location"));
//
//                prispos.put(location, new Prispos(queryResult.getInt("id"), this.main.getPrison(queryResult.getInt("prison")), location, Manipulation.getDinger(queryResult.getString("timing"), true), Material.getMaterial(String.valueOf(queryResult.getInt("item")))));
//            }
        } catch (Exception ex) {
            this.main.log.error(ex);
...
//        this.connection.ExecuteInsert("INSERT INTO prispos(prison, location, timing, item) VALUES(" + prispos.prison.id + ", " + "'" + Manipulation.getLocationWorld(prispos.location) + "', " + "'" + Manipulation.getDinger(prispos.interval) + "', " + prispos.item.name() + ")");
//
...
//        this.connection.ExecuteInsert("INSERT INTO prisgivs(prison, location) VALUES(" + prisgiv.prison.id + ", " + "'" + Manipulation.getLocationWorld(prisgiv.location) + "'" + ")");
//
